...
if __name__== "__main__":
    ...
    parser.add_argument("--masks_color", action='store_true', help="True - different color for deferent class. False - masks are only white")
    parser.add_argument("--clean", action='store_true', help="remove old data from masks_results_path, img_path")
